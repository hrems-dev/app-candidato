...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto py-12 max-w-3xl">
        <h1 class="text-4xl font-bold text-gray-900 mb-8">Nueva Propuesta</h1>

        <form action="{{ route('admin.propuestas.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-8">
            @csrf
